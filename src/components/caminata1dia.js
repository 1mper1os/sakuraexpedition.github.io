      ...
      <div class="rounded-xl overflow-hidden relative bg-white shadow-lg transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-2xl border border-gray-100 flex flex-col h-full">
        <div class="relative overflow-hidden flex-shrink-0">
          ...
          <div class="absolute top-4 right-4 z-20">
            <div class="bg-indigo-600 py-1 px-3 text-sm text-center rounded-lg text-white font-bold shadow-lg backdrop-blur-sm">
        ...
        <div class="p-4 flex-grow flex flex-col justify-between">
          ...
          <div class="pt-2 border-t border-gray-100">
            <button class="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-indigo-700 transition-colors duration-200 text-sm">
              Ver Detalles
            </button>
          </div>
        </div>
